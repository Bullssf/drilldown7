...
export const panelVersionNumber = '2022-11-04 -  2.0.0.7'; //Added to show in panel
...
export function aboutTable( showrepoLink: boolean ) {
    ...
    table.rows.push( createAboutRow('2022-11-04','2.0.0.7'  ,'#253, #254, #245 - Captcha ', showrepoLink === true ? repoLink : null ) );
